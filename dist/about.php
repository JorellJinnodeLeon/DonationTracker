                            ...
                            <div class="card-body">-->
                                ...
                                <div class="text-center">
                                    ...
                                    Magandang Araw! <br />
                                        ...
                                        We can do something beyond locking ourselves in our homes this quarantine season.<br />
                                    ...
                                    -->
                                <h1 class="mt-4">About the Organization</h1>
                                <div class="text-center">
                                    <div class="card" style="width: 60%;">
                                        <img class="card-img-top" src="./assets/img/bayanihan.jpg" alt="Card image cap">
                                        <div class="card-body">
                                            <p class="card-text">Magandang Araw! <br />
                                                ...
                                                Should you have questions or clarifications, please feel free to reach out to me. From time to time, we will also hold zoom meetings and update you guys on the progress. 
                                                <br />
                                                Looking forward to creating a difference with you! </p>
                                        </div>
                                    </div>
                                <!--</div>
                            </div> -->
